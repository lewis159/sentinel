  ...
  return (
    <header className="topbar">
      ...
      <div className="right">
        ...
        <div style={{ width: 30, height: 30, borderRadius: '50%', background: 'linear-gradient(135deg,var(--accent),var(--deep))', color: 'var(--on-accent)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, fontWeight: 700 }}>B</div>
      </div>
    </header>
  );
}
